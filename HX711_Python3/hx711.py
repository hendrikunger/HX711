...
class HX711:
    ...
    def __init__(self,
        ...
        #.setup(self._pd_sck, .OUT)  # pin _pd_sck is output only
        #.setup(self._dout, .IN)  # pin _dout is input only
    ...
    def _read(self):
        ...
        """
        self._pd_sck = False  # start by setting the pd_sck to 0
        ready_counter = 0
